...
- (void)applicationWillEnterForeground:(UIApplication *)application {
	[[StatisticsTracker sharedInstance]loadData];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.C-Elegans.ios_gl_tutorial" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ios_gl_tutorial" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ios_gl_tutorial.sqlite"];
    NSError *error = nil;
